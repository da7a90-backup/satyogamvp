  ...
  if (categories.length === 0) {
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
        ...
        <h3 className="mt-2 text-lg font-semibold text-gray-900">No categories yet</h3>
        <p className="mt-1 text-gray-500">Forum categories will appear here once they are created.</p>
      </div>
    );
  }
    ...
    <div className="space-y-4">
      {categories.map((category) => (
        <Link
          ...
          className="block bg-white rounded-lg border border-gray-200 hover:border-[#7D1A13] hover:shadow-md transition-all"
        >
          <div className="p-6">
            <div className="flex items-start justify-between">
              ...
              {category.latest_thread && (
                <div className="ml-6 text-right min-w-[200px]">
                  <p className="text-sm font-medium text-gray-900 mb-1 truncate max-w-[200px]">
