...
"these compact events also feature wisdom classes, meditation training, and optional meetings with an individual counselor.",
  ...
  const heroData = {tagline:"Ashram Onsite Retreats", background: "/darshanBanner.jpg", heading: "Staying at the Ashram", subtext: "Visit, Study, and Serve at the Sat Yoga Ashram, Costa Rica"}
