...
export default function ShaktiPage({ data, retreatData }: any) {
  // Use retreat data from API - included items section
  const shaktiIncludedData = {
    sectionTitle: retreatData?.included_title || "Included",
  ...
  const introData = {
    leftPane: {
      title: retreatData?.intro1_title || "A Life-Changing Discovery of Your True Nature",
      titleLineHeight: "120%"
    },
    rightPane: {
